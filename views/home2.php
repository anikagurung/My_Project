...
$result = mysqli_query($mysqli,"SELECT * from product ORDER BY id DESC LIMIT 8;");
session_start();
$userId = $_SESSION['id'];
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="cream">
        <nav class="navbar navbar-expand-sm navbar-light">
            <div class="container">
                <a class="navbar-brand" href="home.php">Second life of Books</a>
                ...
                <div class="collapse navbar-collapse" id="mynavbar">
                    ...
                    <a href="cartt.php" style="text-decoration:none; display:inline-block; color: currentColor;">
                    ...
                    <!--<div class="join-seller">-->
                        <a href="becomeseller.php" class="join-seller-link"  style="text-decoration:none; display:inline-block; color: black; margin-right: 20px; margin-top: 10px; margin-bottom: 5px;">Join as Seller
                           <!-- <button class="custom-buttonn" style="text-decoration:none; display:inline-block; color: brown; border: none;">Join as Seller</button>--></a>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-4 col-12">
                    ...
                    <h1 style="font-family: 'Times New Roman', Times, serif; text-align: left;"> Buy and sell books for the best price.</h1>
                    <p style="text-align:justify;">Explore a world of knowledge without breaking the bank. Our thrifted books offer affordable access to a diverse range of topics, making learning accessible for everyone</p>
                    ...
                    <div id="demo" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <center>
                                    <img src="photo/smart.jpeg" alt="Los Angeles" class="d-block w-80 img-fluid"style=" height: 400px; ">
                                </center>
            ...
            <div class="row">
                <div class="col">
                    <div class="rounded-box">
                        ...
                        <p style="text-align:justify;">Second Life of Book can be your go-to platform for thrifting second-hand books online. Explore a diverse collection and discover the joy of sustainable reading today!</p>
                </div>
                <div class="col">
                    <h1></h1>
        ...
        <div class="container " id="featured-3">
            ...
            <div class="row  py-5 row-cols-lg-3">
                <div class="feature col">
                    ...
                    <p style="text-align:justify;">Discover new books to read based on your interests, reading history, and the recommendations of other users.</p>
                ...
                <div class="feature col">
                    ...
                    <p style="text-align:justify;">You can sell your pre-owned books and give them second chance by selling with other readers who have love of reading.
                    </p>
                ...
                <div class="feature col">
                    ...
                    <p style="text-align:justify;">You can read experience that other user had and share your thoughts with them.</p>
...
<div class="cream1">
        <div class="container mt-3">
            ...
            <p>Find Your Next Great Read Among Our suggestion.</p>
              ...
              while ($row = mysqli_fetch_array($product)) {
                ...
                <div class="product">
                  ...
                  <div class="product-tile-footer">
                     ...
                     <a href='action.php?id=<?php echo "$row[id]" ?>' onclick="addToCart() ">
  ...
  <div class="cream-container">
    ...
    <div id="product-grid" class="custom-container">
        <?php
        include('config.php');
        $product = mysqli_query($mysqli, "SELECT * FROM product WHERE status='approved' ORDER BY id DESC LIMIT 8");
        if (!empty($product)) {
            while ($row = mysqli_fetch_array($product)) {
                ?>
